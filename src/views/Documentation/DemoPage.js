...
import {
    ...
    // Form
    TextInput, TextField, FileInput, HelperText, ToggleInput,

    PasswordInput, DateInput, DateTimeInput,
...
export const MainPage = () => {
    ...
    // Toggle Switch
    const [toggleIsChecked, setToggle] = useState(false)
    ...
    return (
        <Drawer
            ...
            <Container>
                ...
                <Section>
                    <Heading>PasswordInput</Heading>
                    <PasswordInput label="Text Input" />
                </Section>
                <Section>
                ...
                <Section>
                    <Heading>DateTimeInput</Heading>
                    <DateTimeInput />
                </Section>
                <Section>
                    <Heading>ToggleInput</Heading>
                    <ToggleInput value={toggleIsChecked} onChange={setToggle} />
                </Section>
                <Section>
                    <Heading>File Input</Heading>
                    <FileInput onChange={url => console.log('URL to uploaded file: ', url)}>Upload a File</FileInput>
                </Section>
                <Section>
